...
Item {
    ...
    Rectangle {
        ...
        width: seekControl.duration == 0 ? 0 : background.width * seekControl.playPosition
                                           / seekControl.duration
        color: "black"
        opacity: 0.7
    }
    ...
    Rectangle {
        ...
        x: seekControl.duration == 0 ? 0 : seekControl.playPosition
                                       / seekControl.duration * background.width
        ...
        MouseArea {
            ...
            onCanceled: {
                seekControl.seekPosition = progressHandle.x
                        * seekControl.duration / background.width
    ...
    Timer {
        // Update position also while user is dragging the progress handle
        id: seekTimer
        repeat: true
        interval: 300
